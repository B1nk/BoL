...
local _INTERRUPTIBLE_SPELLS = {
	...
	["Destiny"]                            = { charName = "TwistedFate",  DangerLevel = 3, MaxDuration = 2.5, CanMove = false },
	["ReapTheWhirlwind"]                   = { charName = "Janna",        DangerLevel = 1, MaxDuration = 2.5, CanMove = false },
	["XerathLocusOfPower2"]                = { charName = "Xerath",       DangerLevel = 5, MaxDuration = 2.5, CanMove = false },
	["CaitlynAceintheHole"]                = { charName = "Caitlyn",      DangerLevel = 5, MaxDuration = 2.5, CanMove = false },
	["UrgotSwap2"]                         = { charName = "Urgot",        DangerLevel = 5, MaxDuration = 2.5, CanMove = false },
	["LucianR"]                            = { charName = "Lucian",       DangerLevel = 5, MaxDuration = 2.5, CanMove = true },
}
...
if autoUpdate then
    SourceUpdater("SourceLib", version, "raw.github.com", "/B1nk/BoL/master/common/SourceLib.lua", LIB_PATH .. "SourceLib.lua", "/B1nk/BoL/master/common/SourceLib.version"):SetSilent(silentUpdate):CheckUpdate()
end
