...
function AutoupdaterMsg(msg) print("<font color=\"#6699ff\"><b>Fizz God mode:</b></font> <font color=\"#FFFFFF\">"..msg..".</font>") end
...
function AutoIGN()
	...
	if ts.target ~= nil then
		if ts.target.health <= igniteDMG and tsDistance < 600 and Ready(ignite) then
